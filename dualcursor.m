...
%         th1 = text(double(xv1+th1offset(1)),double(yv1+th1offset(2)),textstring1,'FontSize',8,'Tag','CursorText','Parent',axh);
%         th2 = text(double(xv2+th2offset(1)),double(yv2+th2offset(2)),textstring2,'FontSize',8,'Tag','CursorText','Parent',axh);
        th1 = text(double(xv1+th1offset(1)),double(yv1+th1offset(2)),textstring1,'FontSize',11,'Tag','CursorText','Parent',axh,'visible','off');
        th2 = text(double(xv2+th2offset(1)),double(yv2+th2offset(2)),textstring2,'FontSize',11,'Tag','CursorText','Parent',axh,'visible','off');
...
%             set(gco,'EraseMode','xor')
        ...
        if strcmp(tag,'Cursor') %If clicked on a cursor
            ...
            CNh = text(double(xn),double(yn),cnstr, ...
                'Units','Normalized', ...
...
%                 set(mainhandles.cra,'string',num2str(xy1(1),'%4.1f'));
%                 set(mainhandles.crb,'string',num2str(xy2(1),'%4.1f'));
